...
-- PL/SQL
------------------------------------------------------------------
-- 1. ANONYMOUS PROCEDURE : 이름 없이 1회 실행 저장 프로시져
...
-- 1) 변수선언이 있는 ANOYMOUS PROCEDURE 작성
DECLARE 
    -- 변수 선언부
...
-- PROCEDURE 를 DBMS 에 선 컴파일하여 저장하고
-- 사용하는 객체
...
/*
PROCEDURE SCOTT.SP_MAXIM에 대한 오류:
...
IS
    -- 지역번수 선언 블록, BEGIN ~ END 사이에서 사용되는 변수 선언부
    -- 변수타입 선언시 크기까지 지정
